...
Welcome to the AdminPanel App project. This application is a web-based CRUD developed using vanilla web technologies.
...
>1. Clone this repository: `git clone https://github.com/matiob/adminPanel.git`
